...
public class ProviderHomeActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            fragment = ProviderHomeFragment.newInstance(user);
        } else if (id == R.id.nav_profile) {
            fragment = ProviderProfileFragment.newInstance(user);
        } else if (id == R.id.nav_history) {
            fragment = ProviderHistoryFragment.newInstance(user);
            ...
            if (user.getIsSeeker().equals("false")){
                fragment = AddSeekerRoleFragment.newInstance(user);
            } else {
    ...
    public void changeRoleToSeeker() {
